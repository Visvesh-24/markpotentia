...
export const company = {
  ...
  phone: '+91 93840 90822',
  phoneHref: 'tel:+919384090822',
  emails: ['sales@markpotentia.in'],
  hours: 'Monday – Saturday · 09:00 – 19:00 IST',
  address: 'Coimbatore, Tamil Nadu, India',
  mapUrl: 'https://maps.app.goo.gl/RwKLzBvuV4Yt5pHy8',
  mapEmbed: 'https://www.google.com/maps?q=11.0237983,77.0118672&z=16&output=embed',
};
...
export const heroStats = [
  ...
  { value: 3000, suffix: '+', label: 'Sites powered' },
...
export const timeline = [
  ...
  {
    year: '2018',
    title: 'Expanded into new sectors',
    body: 'Ventured beyond industrial power into hospitality, healthcare and education — broadening our solutions for noise-sensitive and life-critical environments.',
  },
  {
    year: '2025',
...
export const differentiators = [
  {
    ...
    body: 'Built to original-equipment specification as an authorised Ashok Leyland engine OEM — engine integration, acoustic enclosures and control panels delivered by one accountable team.',
  },
  {
    k: '02',
    title: 'Factory-tested reliability',
    body: 'Every set is load-bank tested and protection-verified before it leaves the floor, with documented sign-off. Site commissioning becomes predictable, and there are no surprises after handover — the way mission-critical power should be delivered.',
  },
  {
    k: '03',
    title: 'Lifecycle support',
    body: 'A 70+ strong service organisation backs every installation through its operating life — spares, AMC and field response across Tamil Nadu and Kerala.',
  },
];
...
export const leadership = [
  {
    name: 'Balasubramaniyan Thangavel',
